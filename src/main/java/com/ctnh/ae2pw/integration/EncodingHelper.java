package com.ctnh.ae2pw.integration;
...
public final class EncodingHelper {
    ...
    public static void encodeProcessingRecipe(PatternWorkStationMenu menu, List<List<GenericStack>> genericIngredients,
    ...
    public static void encodeCraftingRecipe(PatternWorkStationMenu menu,
